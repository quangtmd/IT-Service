...
export const MOCK_PRODUCTS: Product[] = [
  ...
  { id: 'lk002', name: 'RAM Corsair Vengeance LPX 32GB (2x16GB) DDR5 5600MHz', mainCategory: "Linh kiện máy tính", subCategory: "RAM (DDR4, DDR5…)", category: 'RAM', price: 4500000, imageUrls: [`https://images.unsplash.com/photo-1628791924953-99a3e62f6b5b?q=80&w=600&auto=format&fit=crop`], description: 'RAM DDR5 hiệu năng cao.', specifications: { 'Dung lượng': '32GB', 'Loại': 'DDR5', 'Tốc độ': '5600MHz' }, stock: 15, status: 'Mới', brand: 'Corsair', tags: ['ram', 'corsair', 'ddr5'] },
