import { Service, Testimonial, PCComponent, Project, User, Order, AdminNotification, UserRole, StaffRole, Article, ServiceTicket } from '../types';
...
// FIX: Add missing MOCK_TICKETS export and move from ServiceTicketView.
