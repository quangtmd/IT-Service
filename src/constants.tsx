...
// Use the environment variable if defined (production), otherwise default to empty string
// to let the Vite proxy handle the routing to the backend (e.g., http://localhost:3001).
// This avoids hardcoding 127.0.0.1:3001 which can bypass the proxy and cause CORS/404 issues.
