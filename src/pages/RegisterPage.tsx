          ...
          <div className="rounded-md shadow-sm space-y-3">
            <div>
              ...
              <input
                ...
                required
                className="appearance-none relative block w-full px-3 py-3 bg-white border border-borderStrong placeholder-textSubtle text-textBase rounded-md focus:outline-none focus:ring-primary focus:border-primary sm:text-sm shadow-sm"
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="appearance-none relative block w-full px-3 py-3 bg-white border border-borderStrong placeholder-textSubtle text-textBase rounded-md focus:outline-none focus:ring-primary focus:border-primary sm:text-sm shadow-sm pr-10"
            ...
            <div>
              ...
              <input
                ...
                autoComplete="new-password"
                required
                className={`appearance-none relative block w-full px-3 py-3 bg-white border ${password && confirmPassword && password !== confirmPassword ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-borderStrong focus:border-primary focus:ring-primary'} placeholder-textSubtle text-textBase rounded-md focus:outline-none sm:text-sm shadow-sm`}
