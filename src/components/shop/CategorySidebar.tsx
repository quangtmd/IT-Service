...
const CategorySidebar: React.FC<CategorySidebarProps> = ({
  ...
  return (
    <div className="bg-bgBase rounded-lg shadow-md border border-borderDefault h-full flex flex-col overflow-hidden">
      ...
      <nav className="flex-grow p-3 space-y-1 overflow-y-auto max-h-[calc(100vh-280px)]">
       ...
       <div className="p-4 border-t border-borderDefault bg-white rounded-b-lg"> {/* Increased padding for footer */}
        {/* Fix: Use Link directly */}
        <Link to="/shop?tags=Bán%20chạy">
            <Button variant="primary" className="w-full !py-3 !text-base shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all"> {/* Larger button */}
