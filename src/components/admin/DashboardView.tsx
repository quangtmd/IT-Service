...
const DashboardView: React.FC<DashboardViewProps> = ({ setActiveView }) => {
    ...
    const summary = useMemo(() => {
        ...
        return {
            ...
            pendingOrders: orders.filter(o => o.status === 'Chờ xử lý'),
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <StatCard title="Lợi nhuận tháng" value={summary.profitThisMonth.toLocaleString('vi-VN')+'₫'} icon="fa-dollar-sign" color="bg-green-500" onClick={() => setActiveView('accounting_dashboard')} />
